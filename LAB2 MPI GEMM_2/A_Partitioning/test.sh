...
mpicxx -o ./MPI_Collective_Matmul main.cpp MPI_Collective_Matmul.cpp Matrix.cpp buffer.cpp
...
do
    ...
    do
        ...
        do
            echo "        运行 #$i"
            # 使用mpiexec运行
            output=$(mpiexec --oversubscribe -n $proc ./MPI_Collective_Matmul $input)
