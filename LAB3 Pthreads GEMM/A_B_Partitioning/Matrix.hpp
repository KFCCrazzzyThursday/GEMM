...
public:
    ...
    friend void partitioned_sequential_matmul(const double *A, const double *B, double *C,
...
void partitioned_sequential_matmul(const double *A, const double *B, double *C,
                                   const int A_start_row, const int A_end_row,
                                   const int B_start_col, const int B_end_col, const int m, const int n, const int k);
